...
def _get_score_from_submissions(submissions_scores, block):
    ...
    if submissions_scores:
        ...
        if submission_value:
            ...
            attempted = first_attempted is not None
            ...
            return (None, None) + (weighted_earned, weighted_possible) + (attempted, first_attempted)
...
def _get_score_from_persisted_or_latest_block(persisted_block, block, weight):
    ...
    return (raw_earned, raw_possible) + weighted_scores + (attempted, first_attempted)
